    ...
    >
      ...
      {!isPanelMinimized && (
        <div style={{ padding: '24px' }}>
          ...
          >
            Selected Example: <strong>{selectedExampleName}</strong>
            <br />
            Queue Remaining: <strong>{queueCount}</strong>
          </div>
            ...
            >
              {queueSummary.map((item) => (
                <div
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px', fontSize: '11px' }}
                >
                  <span
                    style={{
                      width: '10px',
          ...
          >
            {queueCount > 0 ? 'Add Next Box From Queue' : 'Add Box'}
          </button>
          ...
          <button
            ...
            style={{
              ...
              color: '#ffffff',
              border: 'none',
              cursor: isStressTestRunning ? 'not-allowed' : 'pointer',
              opacity: isStressTestRunning ? 0.6 : 1
            }}
          >
          ...
          {stressResult && (
            <div
              style={{
                marginBottom: '10px',
                fontSize: '12px',
                color: stressResult.passed ? '#1AA37A' : '#FF6B35',
                fontWeight: 600
              }}
            >
              Stress Result: Avg {stressResult.avgFps} FPS (Min {stressResult.minFps}) -{' '}
              {stressResult.passed ? 'PASS' : 'CHECK'}
            </div>
          )}
